  ...
  return (
    ...
    >
      ...
      <main>
        ...
        <section
          ref={heroRef}
          className="relative h-[100svh] min-h-[700px] flex items-center pt-32 overflow-hidden bg-on-background"
        >
          <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-gradient-to-t from-[#121212] via-[#121212]/40 to-transparent z-10" />
            <img
              src={
                cms.hero_image_url?.contentValue ||
                'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=2850&q=80'
              }
              srcSet={`
          ...
          <div className="relative z-20 px-6 md:px-12 max-w-7xl mx-auto w-full">
            <div className="max-w-2xl">
              ...
              >
                {cms.hero_subtext?.contentValue ||
                  'Step away from the noise of the world. Experience transformative rituals designed to harmonize mind, body, and spirit in our gold-standard sanctuary.'}
              </motion.p>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="flex flex-col md:flex-row items-center gap-16 mb-32">
              ...
              <AnimatedSection variant="slide-left" className="w-full md:w-1/2">
                <span className="font-label-sm text-label-sm text-primary uppercase tracking-[0.3em] mb-4 block">
                  Our Philosophy
                </span>
                  ...
                  {cms.about_headline?.contentValue ? (
                    <div
                      dangerouslySetInnerHTML={{
                        __html: DOMPurify.sanitize(cms.about_headline.contentValue.replace(/\n/g, '<br/>')),
                      }}
                    />
                  ) : (
                    <>
                ...
                <p className="font-body-md text-on-surface-variant leading-loose mb-6 whitespace-pre-wrap">
                  {cms.about_subtext?.contentValue ||
                    'We believe that true wellness requires an unhurried approach. By merging ancient healing methodologies with modern, evidence-based practices, we create a space where genuine restoration happens.\n\nEvery product, every touch, and every sound in our sanctuary is meticulously chosen to lower cortisol and elevate the spirit.'}
                </p>
              </AnimatedSection>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-16">
              ...
              <AnimatedSection variant="slide-right" className="w-full md:w-1/2">
                ...
                <p className="font-body-md text-on-surface-variant leading-loose mb-6">
                  Our architecture embraces natural light, raw stone, and acoustic damping to ensure that the
                  moment you cross our threshold, the city fades away entirely.
                </p>
              </AnimatedSection>
            </div>
          </div>
        ...
        <AnimatedSection id="services" className="py-32 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-12 h-[2px] bg-primary mx-auto opacity-60 mb-12" />
            ...
            <div className="flex bg-surface-dim p-1 rounded-full border border-outline-variant/30 shadow-inner w-full max-w-md mx-auto relative overflow-hidden">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-full font-label-md tracking-wider transition-all duration-300 relative z-10 ${
                  activeCategory === 'WOMEN' ? 'text-white' : 'text-on-surface hover:text-primary'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-6 rounded-full font-label-md tracking-wider transition-all duration-300 relative z-10 ${
                  activeCategory === 'MEN' ? 'text-white' : 'text-on-surface hover:text-primary'
                }`}
              >
                ...
                <div className="lg:col-span-7 h-full">
                  <Card tilt className="group relative h-full min-h-[400px]" onClick={() => navigate('/book')}>
                    ...
                    <div className="absolute bottom-0 left-0 p-10 z-20 w-full">
                      <span className="inline-block px-3 py-1 rounded-full bg-sage/20 text-white backdrop-blur-md font-label-sm tracking-widest mb-4 border border-sage/30">
                        MASSAGE
                      </span>
                      <h3 className="font-headline-sm text-3xl text-white mb-3">Deep Tissue Harmony</h3>
                      <p className="text-white/70 font-body-md max-w-md">
                        Unlock deep-seated tension with our signature rhythmic pressure techniques.
                      </p>
                    </div>
                  </Card>
                </div>
                ...
                <div className="lg:col-span-5 grid grid-rows-2 gap-6">
                  <div className="h-full">
                    <Card tilt className="group relative h-full" onClick={() => navigate('/book')}>
                      ...
                      <div className="absolute bottom-0 left-0 p-8 z-20">
                        <span className="inline-block px-3 py-1 rounded-full bg-secondary/20 text-white backdrop-blur-md font-label-sm tracking-widest mb-3 border border-secondary/30">
                          SKIN
                        </span>
                  ...
                  <div className="h-full">
                    <Card tilt className="group relative h-full" onClick={() => navigate('/book')}>
                      ...
                      />
                      <div className="absolute bottom-0 left-0 p-8 z-20">
                        <span className="inline-block px-3 py-1 rounded-full bg-primary/20 text-white backdrop-blur-md font-label-sm tracking-widest mb-3 border border-primary/30">
                          HAIR
                        </span>
                ...
                <div className="lg:col-span-7 h-full">
                  <Card tilt className="group relative h-full min-h-[400px]" onClick={() => navigate('/book')}>
                    ...
                    <div className="absolute bottom-0 left-0 p-10 z-20 w-full">
                      ...
                      <p className="text-white/70 font-body-md max-w-md">
                        Precision cutting and traditional hot towel shave for the modern gentleman.
                      </p>
                    </div>
                  </Card>
                </div>
        ...
        <AnimatedSection id="testimonials" className="py-32 px-6 md:px-12 max-w-7xl mx-auto overflow-hidden">
          <div className="flex flex-col md:flex-row items-center gap-16 lg:gap-24">
            <div className="w-full md:w-1/2 relative">
              <span className="font-label-sm text-label-sm text-primary uppercase tracking-[0.3em] mb-6 block">
                The Experience
              </span>
              <h2 className="font-display-lg text-5xl md:text-6xl text-on-surface mb-8 leading-[1.1]">
                Voices of <br />
                Serenity
              </h2>
              <div className="relative mb-20 md:mb-0 after:content-[''] after:absolute after:left-1/2 after:bottom-[-60px] after:w-[1px] after:h-[60px] after:bg-primary after:opacity-30" />
            </div>

            <div className="w-full md:w-1/2 relative">
              <div className="glass-panel p-12 md:p-16 rounded-[2.5rem] relative z-10 shadow-xl">
                <span className="material-symbols-outlined text-primary text-6xl mb-8 opacity-40 font-light">
                  format_quote
                </span>
                <p className="font-serif text-xl italic text-on-surface mb-10 leading-loose">
                  The moment I walked through the doors of Lumina, the weight of the city just vanished. The
                  Deep Tissue Harmony ritual wasn't just a massage; it was a profound reset for my entire being.
                  Truly the most premium experience in the city.
                </p>
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-label-sm tracking-wider text-on-surface-variant uppercase mt-1">
                      Private Equity Partner
                    </p>
                  </div>
                </div>
              </div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-primary/5 rounded-full blur-[80px] z-0 pointer-events-none" />
            </div>
          </div>
        </AnimatedSection>
          ...
          <div className="relative bg-on-background rounded-[3rem] p-16 md:p-32 text-center overflow-hidden shadow-2xl">
            <div className="absolute inset-0 opacity-40 mix-blend-overlay">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1600334089648-b5d9d06b52dc?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')",
                }}
              />
            </div>
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#121212]/80" />
