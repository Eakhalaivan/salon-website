    ...
    <div className="pt-32 pb-24 min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        <motion.div ref={heroRef} style={{ y, opacity }} className="text-center mb-16">
          ...
          <AnimatedSection variant="fade" delay={0.4}>
            <p className="text-body-lg text-on-surface-variant leading-relaxed">
              Everything you need to know about your LuxeSuite experience.
            </p>
          </AnimatedSection>
        </motion.div>
        ...
        <AnimatedSection variant="fade" delay={0.8} className="mt-16 text-center">
          <div className="inline-flex flex-col items-center p-8 glass-panel rounded-3xl">
            ...
            <button className="px-8 py-3 bg-primary text-on-primary rounded-full font-label-md hover:bg-primary-600 transition-colors">
              Contact Us
            </button>
          </div>
        </AnimatedSection>
