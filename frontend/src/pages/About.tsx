...
import { Sparkles, Heart, Leaf, Star, Trophy, Users, Building } from 'lucide-react';
...
const values = [
  ...
  {
    title: 'Genuine Care',
    description: 'Your well-being is our priority. We listen, understand, and tailor every experience to you.',
    icon: Heart,
  },
  {
    title: 'Sustainable Beauty',
    description: 'We are committed to ethical practices, using sustainable and eco-friendly products wherever possible.',
    icon: Leaf,
  },
];
